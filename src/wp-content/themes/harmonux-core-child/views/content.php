    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
      <header class="entry-header">
          ...
          if ( '' != get_the_post_thumbnail() ) {
            ...
            <div class="smartlib-thumbnail-caption"><a href="<?php echo the_permalink(); ?>" class="smartlib-caption-link"><?php esc_html_e('Read more', 'harmonux') ?>  <i class="fa fa-angle-right"></i></a></div>
            </div>
