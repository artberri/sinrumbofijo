  ...
  <div class="row">
    ...
    <div class="columns large-12 medium-10 small-8">
      ...
      <nav id="top-navigation" class="left show-for-large-up">
        <a class="harmonux-wai-info harmonux-skip-link" href="#content" title="<?php esc_attr_e( 'Skip to content', 'harmonux' ); ?>"><?php esc_html_e( 'Skip to content', 'harmonux' ); ?></a>
        <?php
...
<div id="wrapper" class="row">
  <div id="page" role="main" class="<?php echo esc_attr(get_class_of_component('content')); ?>">
